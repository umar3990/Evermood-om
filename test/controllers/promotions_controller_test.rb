...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { code: @promotion.code, datetime: @promotion.datetime, expiry_date: @promotion.expiry_date, free_items: @promotion.free_items, name: @promotion.name, start_date: @promotion.start_date } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { code: @promotion.code, datetime: @promotion.datetime, expiry_date: @promotion.expiry_date, free_items: @promotion.free_items, name: @promotion.name, start_date: @promotion.start_date } }
